          ...
          children: [
            GestureDetector(
              onTapDown: (TapDownDetails details) async{
                ...
                child: Image.asset("assets/page8.png",height: 700,width: 400,)),
            CustomPaint(
              painter: isCall? MyCustomPainter(9,xyValue):TestPaint(8, xyValue),
              // set the size of the CustomPaint to match the size of the image
              // size: Size(700, 400),
            ),
          ],
        ),
